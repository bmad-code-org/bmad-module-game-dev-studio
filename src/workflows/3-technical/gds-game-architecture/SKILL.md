...
Run: `python3 scripts/resolve-customization.py gds-game-architecture --key inject --key additional_resources`
...
Run: `python3 scripts/resolve-customization.py gds-game-architecture --key inject.after`
