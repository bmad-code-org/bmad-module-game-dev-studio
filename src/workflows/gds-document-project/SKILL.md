...
Run: `python3 scripts/resolve-customization.py gds-document-project --key inject --key additional_resources`
...
Run: `python3 scripts/resolve-customization.py gds-document-project --key inject.after`
