...
Run: `python ./scripts/resolve-customization.py gds-game-architecture --key inject --key additional_resources`
...
Run: `python ./scripts/resolve-customization.py gds-game-architecture --key inject.after`
