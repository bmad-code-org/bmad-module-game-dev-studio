...
Run: `python ./scripts/resolve-customization.py gds-create-gdd --key inject --key additional_resources`
...
Run: `python ./scripts/resolve-customization.py gds-create-gdd --key inject.after`
