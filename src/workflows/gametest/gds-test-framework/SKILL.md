...
Run: `python ./scripts/resolve-customization.py gds-test-framework --key inject --key additional_resources`
...
Run: `python ./scripts/resolve-customization.py gds-test-framework --key inject.after`
