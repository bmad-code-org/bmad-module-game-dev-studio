...
Run: `python3 scripts/resolve-customization.py gds-test-automate --key inject --key additional_resources`
...
Run: `python3 scripts/resolve-customization.py gds-test-automate --key inject.after`
