...
Run: `python3 scripts/resolve-customization.py gds-create-gdd --key inject --key additional_resources`
...
Run: `python3 scripts/resolve-customization.py gds-create-gdd --key inject.after`
