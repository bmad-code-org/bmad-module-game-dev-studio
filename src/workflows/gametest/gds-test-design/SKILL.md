...
Run: `python ./scripts/resolve-customization.py gds-test-design --key inject --key additional_resources`
...
Run: `python ./scripts/resolve-customization.py gds-test-design --key inject.after`
