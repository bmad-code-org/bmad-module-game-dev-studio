...
Run: `python3 scripts/resolve-customization.py gds-performance-test --key inject --key additional_resources`
...
Run: `python3 scripts/resolve-customization.py gds-performance-test --key inject.after`
